...
function create_spritz(){
     ...
     spritz_loader = function() {
        ...
        getURL("../js/ext/glance/spritz.html", function(data){
...
function spritzify(input){
    ...
    const prepString = "... Ready? ... 3 ... 2 ... 1 ... GO! ";
